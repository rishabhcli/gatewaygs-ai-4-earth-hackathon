...
- Tuning on the hero event and calling it held out
- Reporting a point flux without an interval
- Adding a chatbot/map dashboard that obscures the retrieval evidence
- Claiming global or landfill coverage from bright arid validation sites
